...
export type GetMenuCategoriesQuery = { __typename?: 'Query', getMenuCategories: Array<{ __typename?: 'MenuCategory', id: string, name: string, order: number, items?: Array<{ __typename?: 'MenuItem', categoryId: string, id: string, menuId: string, name: string }> | null }> };
