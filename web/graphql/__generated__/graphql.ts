...
export type UpdateMenuItemMutation = { __typename?: 'Mutation', updateMenuItem: { __typename?: 'MenuItem', id: string, menuId: string, name: string, description: string, price: number, ingredients: Array<{ __typename?: 'MenuItemIngredient', ingredient: { __typename?: 'Ingredient', id: string, name: string, ingredientCategory: { __typename?: 'IngredientCategory', id: string, name: string } } }> } };
