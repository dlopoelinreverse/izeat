...
export type CreateDishAndMenuItemInput = {
...
export type Mutation = {
  __typename?: 'Mutation';
  cancelWaiterCall: Order;
  createCheckoutSession: CheckoutSessionResult;
  createCustomerPortalSession: CheckoutSessionResult;
  createDemoAccount: DemoAccountResult;
  createDish: Dish;
  createDishAndMenuItem: MenuItem;
  ...
  renameMenu: Menu;
  reorderMenuCategories: Scalars['Boolean']['output'];
  setActiveMenu: Menu;
  ...
  updateProfile: MeResult;
  updateTable: RestaurantTable;
  verifyCheckoutSession?: Maybe<UserSubscription>;
};


export type MutationCancelWaiterCallArgs = {
...
export type MutationCreateDishAndMenuItemArgs = {
  input: CreateDishAndMenuItemInput;
};
...
export type MutationReorderMenuCategoriesArgs = {
  menuId: Scalars['String']['input'];
...
export type Query = {
  ...
  getMenus: Array<Menu>;
  getRestaurantDishes: Array<Dish>;
...
export type QueryGetRestaurantDishesArgs = {
  restaurantId: Scalars['String']['input'];
...
export type QueryGetTableOrdersArgs = {
  restaurantId: Scalars['ID']['input'];
  tableId: Scalars['ID']['input'];
};
...
export type CancelWaiterCallMutationVariables = Exact<{
  orderId: Scalars['ID']['input'];
}>;


export type CancelWaiterCallMutation = { __typename?: 'Mutation', cancelWaiterCall: { __typename?: 'Order', id: string, status: string, type: string } };
...
export type CreateOrderMutation = { __typename?: 'Mutation', createOrder: { __typename?: 'Order', id: string, restaurantId: string, tableId: string, status: string, type: string, createdAt: any, items?: Array<{ __typename?: 'OrderItemSnapshot', id: string, name: string, price: number, qty: number }> | null } };
...
export type CreateDemoAccountMutation = { __typename?: 'Mutation', createDemoAccount: { __typename?: 'DemoAccountResult', restaurantId: string } };
...
export type DeleteDishMutation = { __typename?: 'Mutation', deleteDish: { __typename?: 'DeleteDishResponse', id: string } };
...
export type CreateMenuMutation = { __typename?: 'Mutation', createMenu: { __typename?: 'Menu', name: string, id: string, isActive: boolean, restaurantId: string, categories?: Array<{ __typename?: 'MenuCategory', id: string, name: string }> | null, items?: Array<{ __typename?: 'MenuItem', id: string, categoryId: string, menuId: string, dishId: string, dish: { __typename?: 'Dish', id: string, name: string } }> | null } };
...
export type CreateDishAndMenuItemMutationVariables = Exact<{
  input: CreateDishAndMenuItemInput;
}>;


export type CreateDishAndMenuItemMutation = { __typename?: 'Mutation', createDishAndMenuItem: { __typename?: 'MenuItem', id: string, categoryId: string, menuId: string, dishId: string, priceOverride?: number | null, dish: { __typename?: 'Dish', id: string, name: string, description: string, price: number } } };
...
export type LinkDishToCategoryMutationVariables = Exact<{
  menuItemInput: MenuItemInput;
}>;


export type LinkDishToCategoryMutation = { __typename?: 'Mutation', createMenuItem: { __typename?: 'MenuItem', id: string, categoryId: string, menuId: string, dishId: string, priceOverride?: number | null, dish: { __typename?: 'Dish', id: string, name: string, description: string, price: number } } };
...
export type UpdateDishMutation = { __typename?: 'Mutation', updateDish: { __typename?: 'Dish', id: string, name: string, description: string, price: number, ingredients: Array<{ __typename?: 'DishIngredient', ingredient: { __typename?: 'Ingredient', id: string, name: string, ingredientCategory: { __typename?: 'IngredientCategory', id: string, name: string } } }> } };
...
export type UpdateMenuItemMutation = { __typename?: 'Mutation', updateMenuItem: { __typename?: 'MenuItem', id: string, menuId: string, dishId: string, categoryId: string, priceOverride?: number | null, dish: { __typename?: 'Dish', id: string, name: string, description: string, price: number, ingredients: Array<{ __typename?: 'DishIngredient', ingredient: { __typename?: 'Ingredient', id: string, name: string, ingredientCategory: { __typename?: 'IngredientCategory', id: string, name: string } } }> } } };
...
export type RenameMenuMutation = { __typename?: 'Mutation', renameMenu: { __typename?: 'Menu', id: string, name: string } };

export type ReorderMenuCategoriesMutationVariables = Exact<{
  menuId: Scalars['String']['input'];
  orderedIds: Array<Scalars['String']['input']> | Scalars['String']['input'];
}>;


export type ReorderMenuCategoriesMutation = { __typename?: 'Mutation', reorderMenuCategories: boolean };
...
export type CreateRestaurantMutation = { __typename?: 'Mutation', createRestaurant: { __typename?: 'Restaurant', id: string, name: string, tables: Array<{ __typename?: 'RestaurantTable', id: string, number: number, status: string, capacity: number }>, menus: Array<{ __typename?: 'Menu', id: string, name: string, restaurantId: string, categories?: Array<{ __typename?: 'MenuCategory', id: string, name: string }> | null, items?: Array<{ __typename?: 'MenuItem', menuId: string, id: string, dishId: string, dish: { __typename?: 'Dish', id: string, name: string } }> | null }> } };

export type CreateCheckoutSessionMutationVariables = Exact<{ [key: string]: never; }>;


export type CreateCheckoutSessionMutation = { __typename?: 'Mutation', createCheckoutSession: { __typename?: 'CheckoutSessionResult', url: string } };

export type CreateCustomerPortalSessionMutationVariables = Exact<{ [key: string]: never; }>;


export type CreateCustomerPortalSessionMutation = { __typename?: 'Mutation', createCustomerPortalSession: { __typename?: 'CheckoutSessionResult', url: string } };
...
export type VerifyCheckoutSessionMutation = { __typename?: 'Mutation', verifyCheckoutSession?: { __typename?: 'UserSubscription', id: string, status: string } | null };
...
export type UpdateProfileMutation = { __typename?: 'Mutation', updateProfile: { __typename?: 'MeResult', id: string, name: string, email: string, image?: string | null } };

export type GetRestaurantDishesQueryVariables = Exact<{
  restaurantId: Scalars['String']['input'];
  search?: InputMaybe<Scalars['String']['input']>;
}>;


export type GetRestaurantDishesQuery = { __typename?: 'Query', getRestaurantDishes: Array<{ __typename?: 'Dish', id: string, name: string, description: string, price: number, ingredients: Array<{ __typename?: 'DishIngredient', ingredient: { __typename?: 'Ingredient', id: string, name: string } }> }> };
...
export type GetRestaurantOrdersQuery = { __typename?: 'Query', getRestaurantOrders: Array<{ __typename?: 'Order', id: string, restaurantId: string, tableId: string, status: string, type: string, createdAt: any, items?: Array<{ __typename?: 'OrderItemSnapshot', id: string, name: string, price: number, qty: number }> | null }> };
...
export type GetActiveMenuQuery = { __typename?: 'Query', getActiveMenu?: { __typename?: 'MenuResponse', id: string, name: string, isActive: boolean, restaurantId: string, categories?: Array<{ __typename?: 'MenuCategory', id: string, name: string, items?: Array<{ __typename?: 'MenuItem', id: string, priceOverride?: number | null, dish: { __typename?: 'Dish', id: string, name: string, description: string, price: number, ingredients: Array<{ __typename?: 'DishIngredient', ingredient: { __typename?: 'Ingredient', name: string } }> } }> | null }> | null } | null };
...
export type GetMenuCategoriesQuery = { __typename?: 'Query', getMenuCategories: Array<{ __typename?: 'MenuCategory', id: string, name: string, order: number, items?: Array<{ __typename?: 'MenuItem', id: string, categoryId: string, menuId: string, dishId: string, priceOverride?: number | null, dish: { __typename?: 'Dish', id: string, name: string, description: string, price: number } }> | null }> };
...
export type GetMenuItemQuery = { __typename?: 'Query', getMenuItem?: { __typename?: 'MenuItem', id: string, categoryId: string, dishId: string, priceOverride?: number | null, dish: { __typename?: 'Dish', id: string, name: string, description: string, price: number, ingredients: Array<{ __typename?: 'DishIngredient', ingredient: { __typename?: 'Ingredient', id: string, name: string, available: boolean, ingredientCategory: { __typename?: 'IngredientCategory', id: string, name: string } } }> } } | null };
...
export type GetTableOrdersQuery = { __typename?: 'Query', getTableOrders: Array<{ __typename?: 'Order', id: string, restaurantId: string, tableId: string, status: string, type: string, createdAt: any, items?: Array<{ __typename?: 'OrderItemSnapshot', id: string, name: string, price: number, qty: number }> | null }> };

export type MySubscriptionQueryVariables = Exact<{ [key: string]: never; }>;


export type MySubscriptionQuery = { __typename?: 'Query', mySubscription?: { __typename?: 'UserSubscription', id: string, status: string, currentPeriodEnd?: any | null } | null };
...
export type MeQuery = { __typename?: 'Query', me: { __typename?: 'MeResult', id: string, name: string, email: string, image?: string | null, hasActiveSubscription: boolean, isDemo: boolean, onboarding?: { __typename?: 'Onboarding', hasRestaurant: boolean, restaurantId?: string | null, restaurantName?: string | null, hasMenu: boolean, hasCategory: boolean, hasDish: boolean, hasTable: boolean, isReady: boolean } | null } };
...
export type OrderCreatedSubscription = { __typename?: 'Subscription', orderCreated: { __typename?: 'Order', id: string, restaurantId: string, tableId: string, status: string, type: string, createdAt: any, items?: Array<{ __typename?: 'OrderItemSnapshot', id: string, name: string, price: number, qty: number }> | null } };
...
export type OrderUpdatedSubscription = { __typename?: 'Subscription', orderUpdated: { __typename?: 'Order', id: string, restaurantId: string, tableId: string, status: string, type: string, createdAt: any, items?: Array<{ __typename?: 'OrderItemSnapshot', id: string, name: string, price: number, qty: number }> | null } };


export const CancelWaiterCallDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CancelWaiterCall"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"orderId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"cancelWaiterCall"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"orderId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"orderId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"type"}}]}}]}}]} as unknown as DocumentNode<CancelWaiterCallMutation, CancelWaiterCallMutationVariables>;
...
export const CreateDemoAccountDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateDemoAccount"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"restaurantName"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createDemoAccount"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"restaurantName"},"value":{"kind":"Variable","name":{"kind":"Name","value":"restaurantName"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"restaurantId"}}]}}]}}]} as unknown as DocumentNode<CreateDemoAccountMutation, CreateDemoAccountMutationVariables>;
export const DeleteDishDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteDish"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteDish"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<DeleteDishMutation, DeleteDishMutationVariables>;
...
export const CreateDishAndMenuItemDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateDishAndMenuItem"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateDishAndMenuItemInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createDishAndMenuItem"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"categoryId"}},{"kind":"Field","name":{"kind":"Name","value":"menuId"}},{"kind":"Field","name":{"kind":"Name","value":"dishId"}},{"kind":"Field","name":{"kind":"Name","value":"priceOverride"}},{"kind":"Field","name":{"kind":"Name","value":"dish"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"price"}}]}}]}}]}}]} as unknown as DocumentNode<CreateDishAndMenuItemMutation, CreateDishAndMenuItemMutationVariables>;
...
export const LinkDishToCategoryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"LinkDishToCategory"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"menuItemInput"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"MenuItemInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createMenuItem"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"menuItemInput"},"value":{"kind":"Variable","name":{"kind":"Name","value":"menuItemInput"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"categoryId"}},{"kind":"Field","name":{"kind":"Name","value":"menuId"}},{"kind":"Field","name":{"kind":"Name","value":"dishId"}},{"kind":"Field","name":{"kind":"Name","value":"priceOverride"}},{"kind":"Field","name":{"kind":"Name","value":"dish"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"price"}}]}}]}}]}}]} as unknown as DocumentNode<LinkDishToCategoryMutation, LinkDishToCategoryMutationVariables>;
export const UpdateDishDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateDish"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"updateDishInput"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateDishInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateDish"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"updateDishInput"},"value":{"kind":"Variable","name":{"kind":"Name","value":"updateDishInput"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"price"}},{"kind":"Field","name":{"kind":"Name","value":"ingredients"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"ingredient"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"ingredientCategory"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]}}]}}]}}]} as unknown as DocumentNode<UpdateDishMutation, UpdateDishMutationVariables>;
...
export const RenameMenuDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RenameMenu"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"menuId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"name"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"renameMenu"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"menuId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"menuId"}}},{"kind":"Argument","name":{"kind":"Name","value":"name"},"value":{"kind":"Variable","name":{"kind":"Name","value":"name"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]} as unknown as DocumentNode<RenameMenuMutation, RenameMenuMutationVariables>;
export const ReorderMenuCategoriesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ReorderMenuCategories"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"menuId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"orderedIds"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"reorderMenuCategories"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"menuId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"menuId"}}},{"kind":"Argument","name":{"kind":"Name","value":"orderedIds"},"value":{"kind":"Variable","name":{"kind":"Name","value":"orderedIds"}}}]}]}}]} as unknown as DocumentNode<ReorderMenuCategoriesMutation, ReorderMenuCategoriesMutationVariables>;
...
export const CreateCustomerPortalSessionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateCustomerPortalSession"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createCustomerPortalSession"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"url"}}]}}]}}]} as unknown as DocumentNode<CreateCustomerPortalSessionMutation, CreateCustomerPortalSessionMutationVariables>;
export const VerifyCheckoutSessionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"VerifyCheckoutSession"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"sessionId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"verifyCheckoutSession"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"sessionId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"sessionId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}}]}}]} as unknown as DocumentNode<VerifyCheckoutSessionMutation, VerifyCheckoutSessionMutationVariables>;
...
export const GetRestaurantDishesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetRestaurantDishes"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"restaurantId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"search"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getRestaurantDishes"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"restaurantId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"restaurantId"}}},{"kind":"Argument","name":{"kind":"Name","value":"search"},"value":{"kind":"Variable","name":{"kind":"Name","value":"search"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"price"}},{"kind":"Field","name":{"kind":"Name","value":"ingredients"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"ingredient"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]}}]}}]} as unknown as DocumentNode<GetRestaurantDishesQuery, GetRestaurantDishesQueryVariables>;
...
export const GetTableOrdersDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetTableOrders"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"restaurantId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"tableId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getTableOrders"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"restaurantId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"restaurantId"}}},{"kind":"Argument","name":{"kind":"Name","value":"tableId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"tableId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"restaurantId"}},{"kind":"Field","name":{"kind":"Name","value":"tableId"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"price"}},{"kind":"Field","name":{"kind":"Name","value":"qty"}}]}}]}}]}}]} as unknown as DocumentNode<GetTableOrdersQuery, GetTableOrdersQueryVariables>;
