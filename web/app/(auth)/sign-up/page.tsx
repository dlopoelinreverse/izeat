        ...
        <Card className="backdrop-blur-xl bg-white/80 dark:bg-slate-900/80 border-orange-100 dark:border-orange-900/30 shadow-2xl">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardDescription className="text-base text-slate-600 dark:text-slate-400">
              Rejoignez izEat et transformez votre restaurant
            </CardDescription>
          </CardHeader>
          ...
          <CardContent>
            ...
            >
              <form.Field
                ...
                validators={{
                  onBlur: ({ value }) =>
                    !value.trim() ? "Le nom complet est requis." : undefined,
                  onSubmit: ({ value }) =>
                    !value.trim() ? "Le nom complet est requis." : undefined,
                }}
              >
              ...
              <Button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    toast.error("Inscription Google échouée. Veuillez réessayer.");
                    setIsLoading(false);
                  }
                }}
